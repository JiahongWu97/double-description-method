...
void file_write(int row, int col, int a[row][col], const char *_Filename) {
    FILE *fp;
...
void file_write_1(int col, int a[col], const char *_Filename) {
    FILE *fp;
//    fp = fopen("D:\\p\\secure network coding bound 2\\right.txt", "w");
    fp = fopen(_Filename, "w");
...
int binary_search(int value, int n, int a[]) {
