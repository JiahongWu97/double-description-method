...
//gcc -Wl,--stack,4294967296 -o ./cmake-build-debug/r_g_set.exe rank_only.c -pthread
//gcc -Wl,--stack,4294967296 -o ./cmake-build-debug/lex_set.exe rank_only.c -pthread
//gcc -Wl,--stack,4294967296 -o ./cmake-build-debug/lex_rank.exe rank_only.c -pthread
//gcc -Wl,--stack,4294967296 -o ./cmake-build-debug/r_g_rank.exe rank_only.c -pthread
...
void *Thread(void *id) {
    ...
    printf("%dth started.\n", threadid);
    unsigned long long count_pos, count_zero, count_neg;
    count_pos = 0;
    count_zero = 0;
    count_neg = 0;
    int value[len_er];
    unsigned long long sign[3][len_er];
