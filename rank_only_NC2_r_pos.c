...
//r 0.txt D:\p\secure network coding bound 2\c_dd_mine\cmake-build-debug\o_1.txt
//r 0.txt "D:\p\secure network coding bound 2\c_dd_mine\cmake-build-debug\o_1.txt"
...
/*
                        for (int k = 0; k < len_er; ++k) {//有问题，不管了
...
/*
        ...
        file_write_1(len_er, birth_index, "birth_index.txt");
        file_write_1(len_er, inherit_adj, "inherit_adj.txt");
*/
    ...
    printf("final length %d, time:%f\n", len_er, (clock() - time_whole) * 1.0 / 1000);
